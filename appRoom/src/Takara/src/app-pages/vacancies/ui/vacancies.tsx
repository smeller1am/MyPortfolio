...
import { useSendVacancyMutation, vacanciesFormsApi } from '@/shared/clientApi/vacanciesFormApi';
    ...
    <Provider store={store}>
      ...
      <div className="container">
        ...
        <div className="vacancyPreview">
          Работа в компании <span>«Такара»</span> – это возможность стать частью команды
          профессионалов и проникнуться уникальной атмосферойнашего дружного коллектива.
        </div>
        <VacanciesForm />
      </div>
    </Provider>
