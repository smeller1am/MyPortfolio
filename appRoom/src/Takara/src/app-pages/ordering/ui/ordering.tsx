...
export const OrderingPage: FC = () => (
  <div className="container">
    <div className="wrapper"></div>
    <Image className="fish" src="./img/delivery/noCutt.png" width={100} height={100} alt="" />
    ...
    <div className="deliveryInfo">
      ...
      <div className="deliveryInfo__item">
        ...
        <div className="deliveryInfo__item-info">
          ...
          <div className="deliveryInfo__item-infoText">
            ...
            <p>
              При меньшей сумме заказа стоимость доставки рассчитывается
              индивидуально.
            </p>
          </div>
        </div>
      ...
      <div className="deliveryInfo__item">
        ...
        <div className="deliveryInfo__item-info">
          ...
          <div className="deliveryInfo__item-infoText">
            При самовывозе из любого ресторана вы получаете скидку в 20% на весь
            заказ
          </div>
        </div>
      </div>
